...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
	...
	<div id="container">
		...
		<div class="contents reservation_set">
			<div class="basic">
				<dl class="">
					<input type="hidden" name="page_start_num" />
					<input type="hidden" name="page_size" />
					<dd class="name">
						<h3>예약관리 <span class="depth_txt">></span> <b>설명회/캠프 예약설정</b></h3>
						<div class="items">
							<label class="period"><input type="text" name="search_date" class="daterange" value="" style="width:180px;" readonly /><span></span></label>
						</div>
						<div class="search_box">
							<input type="text" name="search_context" placeholder="reg user name">
							<input type="button" class="search_btn">
						</div>
					</dd>
					<dd class="new">
						<button type="button" class="small black" onclick="new_schedule();"><span>New Schedule</span></button>
					</dd>
				</dl>
			</div>
			<div id="detail_list">
				<div class="list">
					<div class="hms_table">
						<table class="tablesorter">
							...
							<thead>
								<tr>
									<th class="type_record">Set Type</th>
									<th class="schedule_record">Target Schedule</th>
									<th class="date_record">Open Schedule</th>
							...
							<!--
								<tr>
									<td class="type_record">
										<span class="reservation_type">해외캠프 일정</span>
									</td>
									<td class="schedule_record">2018년 11월 모집</td>
									<td class="author_record">김영록</td>
									<td class="date_record">2018.10.01</td>
									<td class="delete_record"><button title="Delete" class="icon delete" disabled><span>Delete</span></button></td>
								</tr>
							  -->	
							</tbody>
						</table>
			...
			<div id="detail_info">
				<div class="viewbar">
					<h4><b>예약설정 수정</b></h4>
					<div class="items">
						<select id="reservation_type" style="width:140px;">
							<option value=""></option>
							<option value="RT_SEMINAR">유학/캠프 설명회</option>
							<option value="RT_CAMP">해외캠프 일정</option>
						</select>
					</div>
					<div class="items">
						<label class="period"><input type="text" id="reserve_month" class="month_picker" value="" style="width:150px;" placeholder="모집년월 선택" readonly /></label>
						<script type="text/javascript">
						$(document).ready(function() {
				...
				<div class="page reserve">
					<div class="contents briefing">
						<div class="set_input">
							<ul class="form_table">
								<li>
									<div class="cell">
										<span class="label">노출기간</span>
										<label class="period"><input type="text" name="sub_seminar_date" class="daterange" value="" style="width:180px" readonly /><span></span></label>
									</div>
								</li>
							</ul>
						</div>
						<div class="edit_reserve branch hide">
							<ul class="form_table">
								<li>
									<div class="new_list">
										<div class="add"><span>Add Schedule</span></div>
									</div>
								</li>
							</ul>
						</div>
					</div>
					<div class="contents camp_schedule hide">
						<div class="set_input">
							<ul class="form_table">
								<li>
									<div class="cell">
										<span class="label">노출기간</span>
										<label class="period"><input type="text" name="sub_camp_date" class="daterange" value="" style="width:180px" readonly /><span></span></label>
									</div>
								</li>
							</ul>
						</div>
						<div class="edit_reserve">
							<ul class="form_table">
								<li>
									<div class="new_list">
										<div class="add"><span>Add Schedule</span></div>
					...
					<div class="create_btn">
						...
						<button type="button" class="small yellow save" disabled onClick="save_reserve()"><span>Save</span></button>
						<button type="button" class="small blue create hide" disabled onClick="save_reserve()"><span>Create</span></button>
					</div>
				</div>
			</div>
		</div>
